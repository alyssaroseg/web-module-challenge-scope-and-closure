...
/*Task 1: counterMaker()
  ...
  count is called outside of the function in counter 2.
  
  2. Which of the two uses a closure? How can you tell?
  both because they both end with the return statement.

  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  
     counter1 would be preferrable if no changes needed to be made to 'count'.
     counter 1 would be preferrable if changes needed to be made to 'count'
*/
